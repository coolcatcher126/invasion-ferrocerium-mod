...
public class ModBlockLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.STRANGE_ALLOY_BLOCK);

        addDrop(ModBlocks.ALUMINUM_ORE_BLOCK, multipleOreDrops(ModBlocks.ALUMINUM_ORE_BLOCK, ModItems.RAW_ALUMINUM, 2, 5));
        addDrop(ModBlocks.DEEPSLATE_ALUMINUM_ORE_BLOCK, multipleOreDrops(ModBlocks.DEEPSLATE_ALUMINUM_ORE_BLOCK, ModItems.RAW_ALUMINUM, 3, 6));
