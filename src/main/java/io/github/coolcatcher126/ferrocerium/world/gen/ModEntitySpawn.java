...
public class ModEntitySpawn {
    public static void addSpawns() {
        ...
        SpawnRestriction.register(ModEntities.ANT_SCOUT_BOT, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, HostileEntity::canSpawnInDark);
    }
}
