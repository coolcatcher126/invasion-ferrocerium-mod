...
public class ModItems {
    ...
    public static final Item ALIEN_BUILDER_BOT_SPAWN_EGG = registerItem("alien_builder_bot_spawn_egg",
            new SpawnEggItem(ModEntities.ALIEN_BUILDER_BOT, 0x000000, 0x0000ff, new Item.Settings()));
